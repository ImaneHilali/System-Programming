...
int final_result;
    ...
    int seqresult;
    if (operator_priority(inter_op[0]) > operator_priority(inter_op[1])) {
        seqresult = perform_operation(seqresult1, seqresult2, inter_op[0]);

        seqresult = perform_operation(seqresult, seqresult3, inter_op[1]);
    } else {
        seqresult = perform_operation(seqresult2, seqresult3, inter_op[1]);

        seqresult = perform_operation(seqresult1, seqresult, inter_op[0]);
    }
